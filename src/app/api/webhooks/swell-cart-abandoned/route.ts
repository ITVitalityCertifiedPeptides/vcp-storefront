...
export async function POST(request: Request) {
  ...
  try {
    ...
    const total = formatCurrency(cart.grand_total, cart.currency || "USD");
...
${itemsListHtml(cart.items)}
${cart.checkout_url ? `<p><a href="${cart.checkout_url}">Finish your order</a></p>` : `<p>Head back to <a href="https://www.vitalitycertifiedpeptides.com/cart">your cart</a> to finish checking out.</p>`}`;
    const text = `Hi,
